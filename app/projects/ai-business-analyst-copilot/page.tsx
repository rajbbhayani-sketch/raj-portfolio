  ...
  return (
    <main className="min-h-screen bg-[#07111f] text-white">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 py-14 lg:grid-cols-[0.58fr_0.42fr] lg:items-center">
        <div>
          <p className="text-sm font-black uppercase tracking-[0.28em] text-cyan-200">Live AI Portfolio Demo</p>
        ...
        <Image src="/projects/ai-business-analysis.png" alt="AI business analyst dashboard concept" width={900} height={560} priority className="rounded-lg border border-white/10 bg-white/5 shadow-2xl shadow-black/30" />
      </section>
      ...
      <section id="demo" className="mx-auto grid max-w-7xl gap-6 px-5 py-16 lg:grid-cols-[0.38fr_0.62fr]">
        <aside className="rounded-lg border border-white/10 bg-white/[0.05] p-6">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-cyan-200">Scenario Inputs</p>
          <label className="mt-5 block text-sm font-black text-slate-200" htmlFor="scenario">
        ...
        <div className="grid gap-5">
          <div className="rounded-lg border border-cyan-200/30 bg-white p-6 text-slate-950 shadow-2xl shadow-black/20">
            <p className="text-sm font-black uppercase tracking-[0.22em] text-cyan-700">AI-Generated Business Brief</p>
          ...
          <div className="rounded-lg border border-white/10 bg-white/[0.05] p-5">
            <p className="font-black text-cyan-200">Transparency note</p>
